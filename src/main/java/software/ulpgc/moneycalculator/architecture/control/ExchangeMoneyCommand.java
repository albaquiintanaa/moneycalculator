...
public record ExchangeMoneyCommand(MoneyDialog moneyDialog, CurrencyDialog currencyDialog,
                                   ExchangeRateLoader exchangeRateLoader,
                                   MoneyDisplay moneyDisplay,
                                   SoundPlayer soundPlayer) implements Command {
    ...
    public void execute() {
        ...
        soundPlayer.play(SoundPlayer.Sound.Success);
    }
}
